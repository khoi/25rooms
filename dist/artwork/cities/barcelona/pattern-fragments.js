...
const room=world('barcelona-pattern-fragments','A tile turns into a corner',{wall:'paper',wallTone:.69,floor:'paper',tone:.4,pattern:'tiles',accent:'sun',height:3.84,head:50},(H,R)=>{
  ...
  timber(H,R,8.31,8.16,2.65,2.2,.09,.19,'sun');shape(H,R,H.tile(8.48,8.33,2.31,1.87,.29),'blue',.42);cushion(H,R,8.6,8.5,2.05,1.58,.3,.13,'paper');shape(H,R,H.tile(8.98,8.74,1.34,1.08,.44),'sun',.32);oval(H,R,...H.p(9.2,9.24,.45),12,5,'blue',.55);stroke(H,R,[H.p(8.6,8.6,.51),H.p(8.8,9.1,.64),H.p(10.39,9.7,.5)],'coral',2.1);

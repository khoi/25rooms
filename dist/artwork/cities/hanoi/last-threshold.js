...
const room=world('hanoi-last-threshold','A light left for someone',{wall:false,floor:'blue',tone:.45,head:55},(H,R)=>{
 ...
 benchFrame(H,R,1.48,7.25,3.95,1.55,.67,'sun');
 ...
 timber(H,R,7.33,3.23,3.48,1.2,.07,.81,'teal');
 ...
 bentTube(H,R,[[10.58,7.6,.12],[10.58,7.6,2.43]],3,'sun');
 const broom=H.p(10.58,7.6,.16);shape(H,R,[[broom[0]-3,broom[1]-16],[broom[0]+3,broom[1]-16],[broom[0]+16,broom[1]+3],[broom[0]-16,broom[1]+3]],'sun',.55);
 ...
 metal(H,R,10.45,7.45,.3,.3,.08,.16,'teal');

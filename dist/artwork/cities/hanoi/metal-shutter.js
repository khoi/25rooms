...
import { surface, timber, metal, bentTube, benchFrame, drape } from '../materials.js';
import { masonry, archedBay } from '../structure.js';
import { windowBay, hangingRail, taskLight, floorShadow } from '../joinery.js';
...
const room = world('hanoi-metal-shutter', 'A hinge that moves again', { floor: 'paper', wall: 'paper', wallTone: .83, height: 4.15, head: 38, tone: .52 }, (H, R) => {
  ...
  H.tint([P(.15, 1.44), P(2.48, 1.44), P(2.48, 3.45), P(.15, 3.45)], 'teal', .28);

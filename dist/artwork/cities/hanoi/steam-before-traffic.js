...
import { surface, timber, metal, vessel, bentTube, cushion, floorLight } from '../materials.js';
import { cabinetFrame, basin } from '../structure.js';
import { wallCourse, windowBay, hangingRail, recessedFrame, floorShadow } from '../joinery.js';
...
const room = world('hanoi-steam-before-traffic','The lid catches the dawn',{floor:'sun',tone:.16,pattern:'tiles',accent:'teal',wall:'teal',wallTone:.22,height:3.7,head:35},(H,R)=>{
  ...
  metal(H,R,2.55,3.1,3.75,2.65,.48,.22,'blue');

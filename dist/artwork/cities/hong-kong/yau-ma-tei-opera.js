import { surface, timber, vessel, bentTube, drape, benchFrame, pendant, floorLight, cushion, caneChair } from '../materials.js';
...
const room = world(
  ...
  (H, R) => {
    ...
    drape(H, R, 8.45, 9.89, 1.56, 1.29, 0.95, 0.51, 'paper');

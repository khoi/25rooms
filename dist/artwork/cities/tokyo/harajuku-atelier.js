...
function sewingMachine(H, R) {
  ...
  oval(H, R, x + 28, y - 24, 8, 10, 'blue', .7);
  oval(H, R, x + 28, y - 24, 5, 7, 'paper', 1);
  H.line(R, [[x + 25, y - 29], [x + 31, y - 19]], 'teal', 1.1);
  for (let n = 0; n < 3; n++) oval(H, R, x + 3 + n * 7, y - 30, 2, 2, 'coral', .65);
  shape(H, R, [[x - 27, y - 3], [x - 12, y - 3], [x - 11, y + 2], [x - 26, y + 2]], 'sun', .4, .5);
  H.line(R, [[x - 24, y - 1], [x - 15, y - 1]], 'blue', .6);
  H.glow(x - 19, y + 4, 24, 11, 'sun', .2);
...
function furnishings(H, R) {
  ...
  shape(H, R, H.tile(7.13, 1.04, 3.85, 2.84, .025), 'blue', .2);
  box(H, R, 7.1, 1.02, 3.91, .23, 3.12, .18, 'sun', .65);
  for (let n = 0; n < 9; n++) {
    const [x, y] = H.p(7.35 + n * .23, 1.12, 3.05);
    oval(H, R, x, y, 2.5, 4, 'paper', 1);
  }
  ...
  box(H, R, .49, 3.19, .77, 2.96, .07, 1.04, 'coral', .5);
  for (let n = 0; n < 4; n++) {
    shape(H, R, H.faceJ(1.29, 3.36 + n * .67, .54, .21, .94), 'paper', 1);
    H.line(R, [H.p(1.31, 3.51 + n * .67, .78), H.p(1.31, 3.73 + n * .67, .78)], 'blue', 1.8);
  }
  for (const j of [3.29, 5.99]) box(H, R, 2.58, j, .13, .13, .08, 1.07, 'blue', .65);
  box(H, R, .45, 3.15, 2.32, 3.08, 1.15, .12, 'teal', .7);
  box(H, R, .07, 2.42, .39, 4.37, 1.19, .11, 'sun', .65);
  for (let n = 0; n < 6; n++) {
    const j = 2.61 + n * .54;
    H.line(R, [H.p(.09, j, 3.43), H.p(.09, j, 3.07)], 'blue', 1);
    const [x, y] = H.p(.11, j, 3.07);
    shape(H, R, [[x - 6, y], [x + 6, y], [x + 8, y + 20], [x - 7, y + 17]], colors[n % 3], .6);
  }
  for (let q = 0; q < 7; q++) {
  ...
  for (const i of [4.14, 7.79]) {
    box(H, R, i, 4.7, .18, 2.43, .12, .13, 'blue', .7);
    shape(H, R, [H.p(i, 4.79, .25), H.p(i + .16, 4.79, .25), H.p(i + .42, 5.9, 1.16), H.p(i + .26, 5.9, 1.16)], 'coral', .62);
    shape(H, R, [H.p(i, 7.06, .25), H.p(i + .16, 7.06, .25), H.p(i + .42, 5.9, 1.16), H.p(i + .26, 5.9, 1.16)], 'coral', .62);
  }
  box(H, R, 4.27, 5.35, 3.63, 1.1, .42, .12, 'blue', .6);
  for (let n = 0; n < 3; n++) {
    box(H, R, 4.46, 5.52, 1.17, .87, .57 + n * .15, .12, colors[n], .6);
    H.line(R, [H.p(4.53, 6.42, .62 + n * .15), H.p(5.57, 6.42, .62 + n * .15)], 'paper', .8);
  }
  box(H, R, 4, 4.55, 4.28, 2.85, 1.17, .12, 'sun', .7);
  H.line(R, [H.p(4.08, 7.43, 1.24), H.p(8.17, 7.43, 1.24)], 'coral', 2);
  shape(H, R, [H.p(6.68, 7.05, 1.31), H.p(7.78, 7.05, 1.31), H.p(7.82, 7.48, .64), H.p(7.54, 7.49, .72), H.p(7.2, 7.48, .56), H.p(6.72, 7.48, .69)], 'coral', .66);
  for (let n = 0; n < 5; n++) H.line(R, [H.p(6.79 + n * .2, 7.11, 1.32), H.p(6.86 + n * .2, 7.49, .76)], 'sun', .9);

...
function furnishings(H, R) {
  ...
  storyboard(H, R);
  for (const i of [.35, 7.23]) box(H, R, i, .14, .12, .16, 1.06, 2.46, 'sun', .56);
  for (const z of [1.06, 3.48]) box(H, R, .35, .14, 7, .16, z, .08, 'sun', .56);
  box(H, R, 3.84, .2, 3.26, .78, .04, 1.02, 'teal', .56);
  for (let row = 0; row < 3; row++) {
    shape(H, R, H.faceI(3.94, 1.0, 3.06, .16 + row * .27, .38 + row * .27), 'blue', .6);
    for (let k = 0; k < 3; k++) box(H, R, 4.02 + k * .96, .57, .85, .51, .18 + row * .27, .12, k === row ? 'coral' : 'paper', k === row ? .5 : 1);
  }
  for (let q = 0; q < 4; q++) {
    shape(H, R, H.faceI(4.02 + q * .72, .99, .61, 1.18, 1.83), 'paper', 1);
    bird(H, R, ...H.p(4.32 + q * .72, 1.02, 1.44), .57, q * .3);
    H.line(R, [H.p(4.08 + q * .72, 1.02, 1.24), H.p(4.56 + q * .72, 1.02, 1.24)], 'coral', 1);
  }
  ...
  for (const i of [.76, 3.52]) {
    box(H, R, i, 5.96, .17, 1.7, .05, .98, 'sun', .55);
    H.line(R, [H.p(i + .08, 6.06, .2), H.p(i + .08, 7.56, .95)], 'blue', 2);
    shape(H, R, [H.p(i, 6.01, 1.1), H.p(i, 6.01, 1.59), H.p(i, 7.41, 1.22)], 'blue', .6);
    oval(H, R, ...H.p(i + .18, 6.55, .82), 5, 5, 'coral', .6);
  }
  box(H, R, .69, 5.83, 3.22, 1.95, 1.07, .12, 'teal', .6);
  box(H, R, 1.14, 6.17, 2.28, 1.09, 1.13, .16, 'sun', .55);
  for (let k = 0; k < 7; k++) H.line(R, [H.p(3.44, 6.24 + k * .13, 1.18), H.p(3.44, 6.24 + k * .13, 1.28)], 'blue', .8);
  stroke(H, R, [H.p(1.15, 6.18, 1.16), H.p(.89, 5.61, .25), H.p(.36, 5.37, .24)], 'blue', 1.1);
  box(H, R, .13, 5.18, .19, .47, .19, .28, 'paper', 1);
  for (const j of [5.27, 5.46]) H.dot(...H.p(.33, j, .34), 1.5, 'blue');
  const desk = [H.p(1.03, 6.01, 1.63), H.p(3.51, 6.01, 1.63), H.p(3.51, 7.42, 1.24), H.p(1.03, 7.42, 1.24)];
  shape(H, R, desk, 'sun', .46);
  shape(H, R, [H.p(1.13, 6.12, 1.63), H.p(3.41, 6.12, 1.63), H.p(3.41, 7.31, 1.3), H.p(1.13, 7.31, 1.3)], 'paper', 1);
  H.glow(...H.p(2.25, 6.69, 1.5), 48, 24, 'sun', .18);
  ...
  shape(H, R, [H.p(.42, 9.46, 1.18), H.p(1.58, 9.46, 1.18), H.p(1.58, 9.16, 2.02), H.p(.42, 9.16, 2.02)], 'teal', .65);
  shape(H, R, [H.p(.51, 9.43, 1.27), H.p(1.49, 9.43, 1.27), H.p(1.49, 9.2, 1.92), H.p(.51, 9.2, 1.92)], 'paper', 1);
  for (const i of [.51, 1.4]) box(H, R, i, 9.44, .12, .12, 1.16, .13, 'blue', .7);

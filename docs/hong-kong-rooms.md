# Hong Kong, between water and windows

A collection of exactly 25 contemporary isometric scenes for 25rooms. The tour moves from the working harbour into dense neighbourhoods, then follows the rivers, wetlands, islands, and evening footways back to a single lit window. These are fictional households, businesses, and composite layouts. Sources establish local connections. They do not document the invented occupants, possessions, or floor plans.

Each scene occupies roughly 12 by 12 units, with open front edges and a clear route through its main activity. A tram, ferry, pier shelter, or bird hide uses equivalent boundaries. The large silhouette reads across the collection; hands and posture explain the activity at normal zoom. Around a quarter of the floor remains quiet. Water, distant buildings, and landmarks stay inside bounded background strips.

The shared palette remains paper, blue, teal, coral, and sun. Thin blue outlines, flat tonal planes, irregular printed texture, and selective hatching suggest tile, steel, timber, concrete, and cloth. Artwork contains no lettering. Labels belong in captions. Packages, cards, signs, and artwork use original abstract shapes. Clothing is contemporary and practical, with rehearsal garments limited to the opera room. Different seasons appear as separate visits across the year, rather than one literal day.
...
At early autumn dawn, a fictional boat worker checks a mooring beside Aberdeen Harbour. The Southern District account describes fishing vessels in the harbour and typhoon shelter, with the wholesale market nearby. This scene takes the small working edge between shore and vessel as its subject. [Home Affairs Department: Southern District](https://www.gohk.gov.hk/en/districts/so.php).

A curved sampan bow fills the rear left, beside a narrow timber landing on blue concrete piles. Low gunwales and a cropped canvas canopy define the room without hiding the deck. A diagonal rope leads from the boat to a shore bollard, making the dominant silhouette. The front right stays open as a walking lane. Beyond the stern, a thin water strip contains two distant hulls rather than a whole harbour panorama.

Group a coiled spare line, rubber fenders, a boathook, a life ring, a secured fuel container, a wooden bench, a nonslip mat, a hose, a plastic wash basin, gloves, a covered lunch tin, a thermos, a tied canvas bag, cleats, and a drain grate around their uses. Wet timber is teal with blue end grain. The canopy has one visibly newer patch.
...
ID: `hong-kong-kennedy-town-tram`.

A fictional paused tram at Kennedy Town supplies a compact morning transport interior. Hong Kong Tramways is the primary reference for the city's double-deck tram system; this is a stylized vehicle, not a claim about a particular fleet model or timetable. [Hong Kong Tramways](https://www.hktramways.com/en/).

The strongest shape is a tall, narrow two-level cutaway. The lower cab faces the open front corner; a short upper-deck bench and window band rise behind it. A cropped stair enclosure anchors one rear side. The other rear boundary is a terminus platform with a plain shelter roof. Thin rail grooves curve within the footprint. Keep the driver's hands, the platform doorway, and the bottom stair visible.

Include a control pedestal, a round mirror, a bell housing, a windscreen wiper, vertical grab rails, a stair handrail, narrow seat backs, opening window catches, a fare-equipment block, floor ribs, wheel-arch humps, a small fan, a folded jacket, a lunch bag, an umbrella sleeve, and a platform bin. Route information is an unlettered band. Painted teal body panels contrast with paper windows and blue mechanical edges.

In a 20-second loop, the stationary driver looks into the mirror, checks the doorway, reaches toward the controls, and returns the hand to rest. A passenger near the stair settles their bag. The tram remains stopped throughout this inspection study, so door and vehicle timing cannot contradict one another. A tiny mirror glint and the passenger's bag strap supply secondary motion. Reduced motion holds the mirror-check pose.
...
This fictional cha chaan teng preparation corner opens early on a mild spring morning. Its local anchor is Hong Kong-style milk tea. The Intangible Cultural Heritage Office describes blending, boiling and infusion, force-pouring, brewing, and the milk stage. The animation isolates the tea transfer within that longer process. [ICH Office: Hong Kong-style milk tea making technique](https://www.icho.hk/en/web/icho/representative_list_milk_tea.html).

An L-shaped stainless counter wraps the rear walls, leaving a small working square at its center. The dominant form is a high cloth filter above two handled pots. A pass-through opening on the rear right shows only a booth back and one waiting cup. Pale square tiles, a low extraction canopy, a high louver, and a corner sink establish a working food interior rather than a decorative cafe.

Place tea tins, a scoop, two brewing pots, the hanging filter, a drip tray, a milk jug, a kettle, stacked thick cups, saucers, teaspoons, folded cloths, a wire drying rack, a lidded ingredient tub, a timer face without numbers, a rubber floor mat, and a tucked stool around the counter. Keep the clean cup area separate from the wet station.
...
ID: `hong-kong-north-point-market`.

A fictional covered vegetable stall sits near the Marble Road market streets in North Point on a humid morning. The Eastern District guide identifies the Marble Road hawker stalls; the inventory and seller are original rather than a reconstruction of one stall. [Home Affairs Department: Eastern District](https://www.gohk.gov.hk/en/districts/ea.php).

A scalloped awning cuts a low diagonal across the rear. Below it, three shallow tiers of produce form a stepped wedge, with the weighing counter projecting toward the open front. A cool tiled return wall holds a wash tap. Keep the customer route clear along the front edge and leave a gap between display and wall for the seller's knees and hands.

The display contains leafy greens, pale radishes, aubergines, ginger, spring onions, tomatoes, and mesh onion sacks, grouped into broad silhouettes. Add perforated crates, a round weighing pan, a plain digital scale block, a spray bottle, a steel bowl, a damp cloth, folded reusable bags, an apron, rubber boots, a trolley, a floor drain, and the rolled edge of a rain curtain. Small quantity markers are solid color shapes, never numerals or invented writing.

During a 15-second loop, the seller lifts one reusable basket onto the scale, adjusts the position of its greens, checks it, then sets the basket back on the same low shelf for the waiting customer to inspect. No purchase completes or produce replenishes on screen. The customer leans forward and loosens the handles of an empty shopping bag. A drip falls from the awning into a gutter. Reduced motion freezes the basket on the weighing pan.
...
A fictional household in the Choi Hung neighbourhood prepares a compact dining corner on a weekday morning. The wider Wong Tai Sin district developed through resettlement blocks and housing-estate renewal. This proposal uses that housing context without claiming a surveyed flat in a named block or assuming a redevelopment timetable. [Home Affairs Department: Wong Tai Sin District](https://www.gohk.gov.hk/en/districts/wts.php).

The central shape is a hinged wall table framed by a square window. A narrow kitchenette occupies the rear left, and a tall storage cabinet bounds the rear right. The entrance remains open at the foreground corner. Pale terrazzo-like floor flecks and paper walls keep the footprint bright; a window grille and neighboring pastel wall strips locate the home within close urban housing.

Include a rice cooker, a covered breakfast bowl, a kettle, two mugs, a dish rack, a chopping board, a tea towel, a folding stool, a school backpack, a shoe shelf, an umbrella tray, a fan, stacked storage boxes, a hanging calendar represented by blank squares, a potted cutting, and a repair patch on the table edge. Keep breakfast objects on the side counter until the tabletop is supported.
...
ID: `hong-kong-mong-kok-flowers`.

A fictional flower-shop threshold sits beside Mong Kok's flower market on an ordinary spring morning. The flower market developed from on-street trading into shop operations around Flower Market Road and neighboring streets. The arrangement depicts routine stock care, without treating every visit as a festival. [Home Affairs Department: Mong Kok Flower Market](https://www.gohk.gov.hk/en/spots/spot_detail.php?spot=Mong+Kok+Flower+Market).

A shallow U of tall flower buckets surrounds a florist, creating a soft vertical crown with an open center. A short folding awning and a slatted rear shelf form the two walls. The floor is blue-gray concrete with a drain near the low foreground. Leave an uninterrupted route from the street edge to the rear sink, and keep the bucket rims below the working hands.

Use buckets of lilies, chrysanthemums, small daisies, leafy branches, and unopened buds as separate color masses. Add a watering jug, pruning scissors closed on a mat, a spool of twine, paper sleeves, a spray bottle, a shallow offcut tray, a small step stool, a stock trolley, a striped cloth, a wall tap, a hanging apron, and a folded rain cover. The wrapping paper contains no printed words. Four large blooms establish the silhouette; smaller buds reward closer viewing.

In a 14-second loop, the florist turns a paper-sleeved bunch between both hands above a folding table inside the bucket arc, then pauses to inspect its outline. The bunch remains held throughout. A customer waits with a shopping bag. Leaves settle after contact; a drop falls from a recently watered stem. The still pose holds the bouquet above the worktable so both hands and the curved display remain readable.
...
A fictional fabric merchant measures a sample length in Sham Shui Po before lunch. The district developed textile and garment trades, and still has streets associated with clothing, buttons, lace, and beads. Those documented connections ground this original shop interior. [Home Affairs Department: Sham Shui Po District](https://www.gohk.gov.hk/en/districts/ssp.php).

A long measuring counter cuts diagonally from front left to rear right. Fabric bolts stand in a staggered wall at the back, while large horizontal rolls occupy a lower rack on the other side. One cool clerestory and a half-open metal shutter contain the architecture. The clear customer aisle follows the front edge; the seller has space behind the counter to draw cloth without colliding with the roll rack.

Include striped cotton, plain twill, a translucent offcut, a wooden yardstick without numbers, a flexible tape, heavy shears closed in a tray, pattern weights, folded swatches, a pin cushion, a chalk wedge, paper pattern sheets, a calculator with blank keys, a tube rack, a tote, a step stool, and a desk fan. Keep the broad teal fabric plane dominant; other textiles use restrained bands rather than noisy patterns.
...
ID: `hong-kong-kwun-tong-print`.

A fictional artist works in a converted Kwun Tong industrial unit at midday. The district's former manufacturing area now includes business uses; this studio is an original proposal. [Kwun Tong District](https://www.gohk.gov.hk/en/districts/kt.php). Screenprinting uses a squeegee to push color through unblocked mesh onto paper. [Tate: screenprint](https://www.tate.org.uk/art/art-terms/s/screenprint).

A large square screen-print bed dominates the center, held in a hinged frame at its rear. A tall drying rack makes a thin second silhouette along the back wall. Exposed beams, a broad industrial window, painted concrete, and a utility sink describe the unit. The artist stands on the open right side, with a full route around the front of the bed. Keep the squeegee blade visible against the pale screen.

Include the mesh frame, hinge clamps, a squeegee, a spatula, lidded ink pots, a mixing tile, paper corner stops, a stack of blank sheets, test prints, a drying rack, washing brushes, rubber gloves, a rag basket, a small timer, a stool, and an apron. Prints use an original circle-and-wave design without lettering. The teal printed shape and coral tool handle draw the eye before the shelf details.

The 16-second loop is a pressure-and-position rehearsal with a clean practice screen: the artist lowers the hinged frame, draws the squeegee across, lifts the pressure, returns it to the far edge, then raises the frame. One finished sheet on the nearby drying rack establishes the result. No fresh ink layer accumulates or disappears. The still pose holds the screen down and both hands on the squeegee. A hanging rag shifts slightly beside the open window.
...
A fictional teaching bay near Tsuen Wan introduces bamboo-theatre construction on a dry afternoon. The ICH Office describes temporary theatres made with bamboo poles and fir beams, with metal-sheet coverings for weather protection. Tsuen Wan is also the location of its heritage centre at Sam Tung Uk. This small bay is an invented demonstration setting. [ICH Office: bamboo theatre building technique](https://www.icho.hk/en/web/icho/representative_list_bamboo_theatre.html).

An open skeletal corner frame rises along the rear edges, with a single cropped sheet of roofing above one side. A separate waist-high practice joint stands in the foreground center. Stacked poles run low along the left boundary, leaving the learner's entire working side open. The tall, lightly drawn frame supplies the silhouette without filling the room with an opaque roof.

Include bamboo nodes, fir blocks, a sample joint, coiled binding strips, a lidded tool box, a tape measure, a saw stored in a sleeve, a level, wedges, a clamp, gloves, a hard hat on a peg, a water flask, a small bench, a broom, and a bin for short offcuts. Blue shadows distinguish hollow bamboo ends from solid timber. There are no workers balanced on incomplete high scaffolds.
...
ID: `hong-kong-kowloon-bay-porcelain`.

A fictional porcelain painter has a workbench in Kowloon Bay on a bright afternoon. Guangcai, Canton famille rose porcelain making, reached Hong Kong in the 1920s. It uses overglaze painting on white porcelain before low-temperature firing. The craft association is documented; this particular studio location and design are original. [ICH Office: Guangcai making technique](https://www.icho.hk/en/web/icho/representative_list_guangcai_making_technique.html).

A round plate on a padded turntable forms the focal circle. The bench follows the rear left wall; narrow shelves of plates create a repeated arc behind it. A high factory-style window and a deep sill bound the rear right. A low trolley occupies one front corner, leaving an open approach beside the seated painter. Firing equipment belongs outside this room, keeping the intimate painting stage visually clear.

Include blank porcelain plates, one decorated sample, fine brushes, a brush rest, shallow pigment dishes, a palette, a rinse cup, a padded support ring, a magnifier, a work lamp, cotton cloths, a lidded storage box, a stool cushion, a dust cover, a hand towel, and a drying shelf. The proposed ornament is an original coral blossom with teal leaves and a sun-colored border, with no copied historical pattern or script.

Over 18 seconds, the painter raises the brush to inspect its tip, lowers it near the rim, turns the supported plate a few degrees to assess the curve, then returns plate and hand to their starting positions. The loop is an inspection between painted marks, so the pattern never visibly erases. A curtain edge sways; a reflected window bar moves slightly on the plate. The still pose holds the brush above the rim.
...
A fictional rehearsal room near Yau Ma Tei Theatre sits between work and performance on a spring afternoon. The district guide identifies the theatre, while the ICH Office describes Cantonese opera's stylized movement, voice, costume, percussion, and dramatic skills. This rehearsal does not reproduce a named opera role or ceremonial sequence. [Yau Tsim Mong District](https://www.gohk.gov.hk/en/districts/ytm.php), [ICH Office: Cantonese opera](https://www.icho.hk/en/web/icho/representative_list_cantoneseopera.html).

A pale curtain sweeps down from the back right and frames a clear patch of timber floor. A costume rail and low percussion bench occupy the opposite rear wall. The curtain's tall curve is the main silhouette; the open front edge keeps the performer's whole arm and hem visible. A small mirror is angled inward, so its reflection does not create a second competing figure.

Include rehearsal sleeves, a plain contemporary practice top, soft shoes, a folded robe, costume hangers, a gong, padded mallets at rest, a small drum, a water flask, a towel, a script represented by blank blocks, a fabric bag, a stool, a shoe brush, a floor fan, and a side lamp. Ornament stays restrained because this is preparation rather than a full costumed stage picture.
...
ID: `hong-kong-harbour-ferry`.

A fictional mid-crossing moment aboard a Star Ferry moves the tour across Victoria Harbour. The operator's current site documents its harbour service and fleet. The drawing borrows the ferry's role and broad character rather than asserting a vessel-specific deck plan. [Star Ferry](https://www.starferry.com.hk/en).

A curved hull edge cuts across the open foreground. Two short timber benches face along a wide aisle, while a partial upper-deck overhang caps the rear. Open window bays frame a narrow band of water and small distant tower blocks. A thick vertical stanchion anchors one side, and the low safety rail remains below the passengers' heads. The dominant shape is horizontal and open, contrasting with the tram's tall stack.

Include bench slats, metal seat brackets, round stanchions, a life ring, a lifejacket locker, ventilation slots, a deck drain, an unlettered safety panel, a short rope coil secured off the aisle, a rain jacket, a canvas tote, a camera, a walking stick, a folded newspaper with abstract blocks, a water bottle, and a small bin. Painted teal steel meets sun-colored wood and paper window light.

During a 16-second loop, a seated passenger raises binoculars, follows one distant vessel through a short arc, and lowers them into their lap. Another passenger steadies a bag with a foot. This is a continuous mid-crossing study: no doors open and no boarding sequence occurs. The distant water band scrolls gently as an irregular repeated pattern, with no recognizable tower snapping across the boundary. The still pose holds the binoculars lowered at the passenger's chest, with three travelers seated on the deck.
...
A fictional club boathouse near the Shing Mun River holds a pause after a cool-season training session. Sha Tin's riverside landscape and its recreation routes provide the setting; the Hong Kong rowing association supplies the sporting reference. This is an invented storage bay rather than a surveyed club interior. [Home Affairs Department: Shing Mun River](https://www.gohk.gov.hk/en/spots/spot_detail.php?spot=Shing+Mun+River), [Hong Kong, China Rowing Association](https://www.rowing.org.hk/).

A long narrow rowing shell rests high on a rear rack, with its pointed ends cropped inside the room's boundaries. Below it, parallel oars form a diagonal rhythm above a clear center aisle. An open roller doorway on the right reveals a short launch ramp and bounded river strip. Rubber floor mats contrast with concrete; the roof remains a thin beam line so the oars and athlete stay visible.

Include padded rack arms, two broad oar blades, narrow sculling blades, riggers on the stored shell, a sliding-seat silhouette, a pair of boat shoes, cleaning cloths, a sponge, a wash bucket, a wheeled shell support, a tool pouch, a wall clock with plain marks, water bottles, a cap, a jacket, and a spare strap. No rower carries a full shell alone in the miniature.
...
ID: `hong-kong-tai-po-cycle`.

A fictional cycle-service kiosk near the Tolo Harbour cycling route is busy on a mild weekend afternoon. The Tai Po guide identifies the Tolo Harbour Cycling Track and Tai Mei Tuk among the district's recreation settings. This small repair corner is original and does not claim a particular rental operator. [Home Affairs Department: Tai Po District](https://www.gohk.gov.hk/en/districts/tp.php).

One bicycle stands diagonally across a low service mat, with a tall floor pump making the main upright. A shallow kiosk roof and a perforated tool panel form the rear corner. Spare bicycles appear only as two partial wheel circles against the back wall. The customer waits at the open front left, leaving the pump handle and the hose connection clear. A sliver of path outside contains one abstract cycling-route color band.

Include the bicycle frame, tires, valve hose, pump barrel, round gauge, tool board, tire levers, hex keys, a rag, a shallow parts tray, a helmet, a bell, a wire basket, a drink bottle, a cable lock, a spare inner tube loop, a stool, and a small first-aid box with a plain cross. Blue metal edges and paper tire sidewalls keep the intricate machine readable.

Over 16 seconds, a mechanic braces the pump base with both feet, makes two measured strokes, pauses at the gauge, and returns the handle to its raised starting position. The hose stays attached and the tire silhouette remains stable; this illustrates a brief top-up rather than a visibly flat-to-full transformation repeated forever. The customer tests their helmet strap. Reduced motion holds the pump handle raised and the mechanic's feet planted, ready for the first stroke.
...
A fictional watersports bay on the Sai Kung coast closes a summer afternoon on the water. The public watersports programme includes centres at Chong Hing and Wong Shek in Sai Kung. The shore-side storage arrangement, staff member, and rinsing routine are design proposals rather than operating instructions for one centre. [Leisure and Cultural Services Department: watersports centres](https://www.lcsd.gov.hk/en/watersport/index.html).

A bright rounded kayak rests horizontally on two low trestles. Upright stored hulls make a fan along the rear wall, with a narrow corrugated canopy above them. A tiled hose station occupies the back left; an open right edge shows a small strip of beach and calm blue water. A grated drain runs beneath the working hull, and the front route remains clear of hose coils.

Include a paddle, buoyancy aids on a rail, spray decks on hooks, a sponge, a wash bucket, a hose nozzle, hose reel, rubber sandals, a mesh gear bag, a dry bag with a coral strap, a tied towel, a storage cradle, a wheel trolley, a weatherproof lamp, a drinking-water flask, and a brush. The cockpit rim and pointed bow define the boat; smaller equipment stays subordinate.
...
ID: `hong-kong-tin-shui-wai-hide`.

A fictional quiet observation bay at Hong Kong Wetland Park appears on a cool winter afternoon. The park lies in northern Tin Shui Wai and includes constructed wetland habitats, a mangrove boardwalk, and bird hides. Those features ground this composite room; the precise birds and furniture placement are design choices. [Home Affairs Department: Hong Kong Wetland Park](https://www.gohk.gov.hk/en/spots/spot_detail.php?spot=Hong+Kong+Wetland+Park).

A long narrow viewing slit is the dominant shape in a dark timber wall. A low bench follows it, while an angled return wall protects the entrance on the rear left. Open front edges expose a standing observer and a seated adult companion making field notes. The outside world occupies only a shallow strip of reedbed and water. Sparse vertical reed stems leave one clear gap for a distant egret-like silhouette.

Include binoculars, a scope on a compact tripod, a padded bench, a window ledge, a water bottle, a closed snack box, a field notebook with simple bird drawings, a pencil, a folded jacket, a backpack, lens caps, an adjustable shutter, a low stool, a waste-free packed bag, and textured timber fasteners. Keep the scope out of the main figure's face and the front route free of legs.

Over 14 seconds, the observer lifts binoculars, tracks a small movement across the slit, pauses, and lowers them while the companion makes a note. The bird takes one short step and returns behind a reed clump before reappearing, hiding its reset naturally. Reeds move softly at different speeds; the water remains nearly still. Reduced motion holds the standing observer's binoculars at eye height while the seated companion makes field notes.
...
A fictional shore-side sorting bay at Lau Fau Shan receives shellfish on a mild afternoon. The local district source identifies oyster farming and oyster beds along the shore. This composition concentrates on inspecting whole shells, without inventing an exact farming cycle or shucking method. [Home Affairs Department: Lau Fau Shan](https://www.gohk.gov.hk/en/spots/spot_detail.php?spot=Lau+Fau+Shan).

A low corrugated roof sits above three shallow sorting trays arranged as staggered steps. An open rear edge frames a thin mudflat and water band. The other rear wall carries a hose and work hooks. The dominant shape is the rough mound of shells in the largest tray, with a wide aisle on the front right for the worker's boots and a basket trolley. A drainage channel keeps the wet work visually bounded.

Include ridged oyster shells, perforated baskets, shallow trays, a rinse basin, a hose nozzle, waterproof gloves, rubber boots, an apron, a scraper stored flat, a bucket, a weighing pan, a folded tarp, a trolley, a stool, a drinking flask, a coiled spare rope, and a fan behind a protective grille. Blue and paper marks describe shell ridges without rendering every shell equally.
...
ID: `hong-kong-tai-o-stilt-house`.

A fictional Tai O household uses a covered deck for a quiet repair on a spring afternoon. The district source describes the fishing village's waterways and houses on stilts in narrow channels. The family, net, and layout are original; the scene does not suggest that all residents still earn their living from fishing. [Home Affairs Department: Tai O](https://www.gohk.gov.hk/en/spots/spot_detail.php?spot=Tai+O).

Timber posts lift the rectangular floor over a shallow diamond of blue water. The back wall mixes corrugated cladding and an open shutter; the right edge has a low rail and a small landing. A broad net draped over a waist-high frame gives the interior its main diagonal. The front floor remains open enough to show the posts below, while a clear domestic route links the rear doorway and the landing.

Include a net frame, mesh, a repair shuttle at rest, a twine spool, scissors stored closed, a stool, a bench cushion, enamel cups, a kettle, a folding table, a potted herb, a wall fan, a plastic wash basin, hanging gloves, a boot tray, a small life ring, and a basket of household tools. The work corner shares space with ordinary comforts rather than becoming a fishing museum.

Over 16 seconds, a seated resident lifts slack in the net, tests the tension between two supported points, and lets the same section settle. A second person on the bench drinks from a cup while the frame supports the mesh. This is inspection before a repair; no completed knot disappears. Water reflections pass beneath the floor and the shutter moves slightly on its catch. Reduced motion holds both net corners at the crossbar, with the companion's cup lowered beside the bench.
...
A fictional parcel handoff near Yung Shue Wan pier takes place before the evening return traffic. Yung Shue Wan is Lamma Island's main population center, giving the island's everyday exchange a clear local setting. The trolley and delivery routine are an original small story, not a claim about an operator's logistics. [Home Affairs Department: Lamma Island](https://www.gohk.gov.hk/en/spots/spot_detail.php?spot=Lamma+Island).

A broad low hand trolley occupies the central floor beneath a flat pier shelter. A rear railing exposes a narrow slice of water, and a side wall supports a shallow parcel shelf. One short ramp replaces a foreground step, making a clear route between the trolley and the walkway. The silhouette is low and rectangular, with a tall trolley handle rising beside the worker rather than another boat hull.

Include three plain cardboard parcels, a reusable insulated box, a canvas mail bag without writing, a hand trolley, rubber wheels, a tie-down strap, a folded hand truck, a small weighing mat, a clip board with blank shapes, a rain cover, a bench, an umbrella hook, a water flask, a bollard, a rubber edge strip, and a broom. Packages carry abstract coral and teal marks. Keep the heaviest box low and the handles reachable.
...
ID: `hong-kong-ping-shan-courtyard`.

A fictional shared courtyard in Ping Shan offers a slow late-afternoon board game. The Yuen Long guide describes long-established village communities, traditional buildings, and the Ping Shan Heritage Trail. This is an invented domestic courtyard, not an ancestral hall used as casual scenery or a surveyed heritage monument. [Home Affairs Department: Yuen Long District](https://www.gohk.gov.hk/en/districts/yl.php).

Two low walls of worn plaster and brick form a quiet L around a square game table. A narrow eave and a simple doorway define the rear. One small tree grows beside the wall, with a sparse canopy cropped high above the figures. Pale paving leaves a broad empty foreground and an unobstructed route to the doorway. The table's geometric diamond and the tree's bent branch are the two main shapes.

Include a simple draughts board with unlettered counters, a counter tin, two stools, a woven seat cushion, a tea flask, two cups, a hand fan, a walking cane, a folded cardigan, a broom, a low planter, a drain channel, a watering can, a doorstep, a clay pot, and a bird-shaped doorstop of original design. The game is deliberately generic rather than an inaccurate rendering of character-marked xiangqi pieces.

Over 18 seconds, one neighbor holds a counter above the board, moves it toward a possible square, hesitates at the other's small hand gesture, then returns to the original poised hover. The moment is deliberation, so the board repeats coherently. A leaf trembles and the other neighbor taps the closed fan once on a knee. The reduced-motion pose holds the coral counter near the board edge, with the companion's closed fan beside it.
...
A fictional sketching pause occupies an open shelter beside West Kowloon's waterfront on an early autumn evening. The district source describes the cultural district's Art Park and continuous waterfront promenade. The shelter and artist are original, and the scene does not reproduce a named pavilion's architecture. [Home Affairs Department: West Kowloon Cultural District](https://www.gohk.gov.hk/en/spots/spot_detail.php?spot=West+Kowloon+Cultural+District).

A thin sloping canopy rests on two rear posts above a low parapet. The artist's slanted drawing board makes the dominant interior plane, facing the open front left. A single bench occupies the rear right, with generous empty paving between it and the stool. Harbour water and a compressed skyline sit in a narrow strip above the parapet, never growing into a second city scene.

Include a drawing board, a clipped sheet, graphite pencils, a soft eraser, a small pencil tin, a water bottle, a folding stool, a tote with a coral strap, a spare paper roll, a jacket, a low bench, paving joints, a drain, a planted grass edge, a telescope-like rolled mat, and two large paper clips. The sketch contains only broad original cloud and horizon shapes, with no lettering or miniature copy of the full illustration.
...
ID: `hong-kong-tai-hang-dragon`.

A fictional community preparation bay in Tai Hang appears before the Mid-Autumn Festival. The heritage centre documents a dragon made from rattan, rope, and straw, with the head supported as a substantial structure. This seasonal scene precedes the festival, without asserting an event schedule. [Tai Hang Fire Dragon Heritage Centre: traditional craftsmanship](https://www.firedragon.org.hk/en/inherit-the-fire-dragon-culture/).

A sinuous working section of the dragon rests on low trestles, curving from the back left to a raised head near the open front right. A plain workshop wall and an open storage doorway bound the rear. Sparse canopy beams keep the head and volunteers visible. The main foreground route runs outside the curve, leaving hands clear of poles and supports. The composite shows a short body section and head, with sun-colored straw texture, rattan curves, and a strong blue jaw outline.

Include segmented body sections, support poles, trestles, coiled binding material, spare fiber bundles, scissors in a closed tray, work gloves, brushes, a plain eye disc, a small stool, a water flask, folded cloths, a tool box, a storage rack, and a broom. Any incense bundles remain unlit and stored apart. No smoke, flames, firecrackers, or indoor ritual action competes with the work.

In a 14-second loop, a volunteer straightens a loose supporting tie beside the head, tests the supported form with one palm, and releases the same tie to rest. Another volunteer steadies the trestle. This adjustment is a design gesture rather than a documented construction tutorial. A loose fiber end trembles after the hand withdraws. Reduced motion holds both workers supporting the quiet head.
...
A fictional covered landing near the older residential streets of Wan Chai offers shelter during a summer shower. The Blue House's documented mix of ground-floor commerce, upper-floor homes, balconies, and continued residential use supplies the neighborhood's domestic context. The staircase and awning are an original nearby composition, not the Blue House's actual entrance. [Home Affairs Department: The Blue House](https://www.gohk.gov.hk/en/spots/spot_detail.php?spot=The+Blue+House).

Three short flights form a zigzag of pale steps around a deep landing. A narrow awning projects from a patched plaster wall at the rear left, while an iron railing bounds the upper rear edge. A doorway with a shallow tiled threshold occupies the sheltered side. Keep the central landing broad enough for two people to pass and leave the front risers open so the scene's changing levels read clearly.

Include stair nosings, a handrail, an awning brace, a downpipe, a gutter, a drain grate, a closed umbrella, an umbrella sleeve, a shoulder bag, a door mat, a small potted plant, a wall lamp, an electrical conduit, a folded delivery crate, and worn patches at the stair edges. One rain chain or downpipe carries the water downward; it does not pour across the pedestrian route.
...
ID: `hong-kong-central-walkway`.

A fictional glass-sided pedestrian link in Central receives its late cleaning on an autumn night. Central's documented pedestrian infrastructure includes covered walkways that connect its hillside streets. The elevated link and cleaner are an original contribution to that setting, rather than a claim about a particular building's maintenance staff. [Home Affairs Department: Central to Mid-Levels Escalator and Walkway System](https://www.gohk.gov.hk/en/spots/spot_detail.php?spot=Central+to+Mid-Levels+Escalator+and+Walkway+System).

A rectangular steel portal frames a short raised walkway. One rear side is glass, divided into three broad panes; the other contains a cropped stair opening with a safety rail. The floor extends toward the open front like a small bridge. Keep the center route clear and place the cleaning cart inside a shallow side recess. Far tower windows appear as sparse paper rectangles through blue glass, with no recognizable advertising.

Include the steel frame, glass clamps, handrail, a squeegee, a spray bottle, a cleaning cloth, a lidded bucket, a compact cart, spare mop heads, rubber gloves, a work jacket, a plain triangular floor marker, ceiling strip lights, a drain seam, and a clipped water flask. The marker uses an original shape without words. Reflections remain transparent enough to reveal the cleaner's arm.

During a 16-second loop, the cleaner raises the squeegee to a reachable section of glass, draws one controlled stroke downward, lifts the blade away, and returns it for an overlapping stroke. The surface carries a subtle stable sheen, so a fully dirty pane never reappears. The worker stays on the floor and the cart remains parked. Reduced motion holds the squeegee raised against the pane, ready for its next stroke. A distant lift light changes quietly behind the glass.
...
A fictional Quarry Bay household ends the tour with a small act of care after midnight. The Eastern District guide describes Quarry Bay's change from an industrial center into today's residential and commercial district. The aquarium and household are original domestic choices, with no claim that the room reproduces a particular dense housing block. [Home Affairs Department: Eastern District](https://www.gohk.gov.hk/en/districts/ea.php).

A luminous aquarium on a low cabinet fills the front right and becomes the dominant rectangle. A broad rear window contains close neighboring facades within a shallow view. The kitchenette is only a short counter return at rear left, and a small chair sits beside the tank. Pale floor tiles preserve a clear path from the open front entrance to the window latch. The tank is low enough for the seated resident's face to remain visible.

Include a planted aquarium, a small filter box, a curved air tube, a tank light, a closed fish-food tin, a net hung dry, a water-change bucket tucked away, a glass-cleaning cloth, a mug, a kettle, a phone on a charger, a folded work shirt, a tote, a houseplant, a window fan, and a small cushion. A few small fish have space between plants; nothing suggests an overcrowded ornamental bowl.

Over 20 seconds, the resident follows one fish with a finger outside the glass, lowers the hand to their lap, then looks back toward the same clear area. Fish follow gentle closed paths behind the plants, with direction changes softened by pauses and occlusion. No repeated food falls into the water. A restrained bubble line and one distant window light provide secondary motion. Reduced motion holds the resident watching beside the glowing tank.
...
Related scenes have different dominant geometry and human actions. Aberdeen uses a secured rope and curved bow; the harbour ferry uses a long passenger deck; Lamma uses a low parcel trolley. The rowing bay has high parallel equipment, while the kayak bay has a low rounded hull and rinse stream. Fabric is selected with a stretched tape, printing uses a broad two-handed practice stroke, and porcelain uses a supported plate and fine inspection. North Point's low produce tiers differ from Mong Kok's tall bucket arc. The three homes center on shared furniture, a raised water-edge work platform, and a solitary illuminated tank.

All signs, screens, packages, and diagrams stay free of lettering. Hands retain their props, moving objects meet supports before release, and repetitive studies use inspections or recoverable gestures. Still poses keep the key object beside the person who uses it. The artwork's visual review must inspect the full collection for repeated silhouettes, then check hands, foreground occlusion, and the first and last frames of each loop at room scale.
